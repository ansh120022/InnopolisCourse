...
add_goods_query = f"""Insert into goods
(id, name, package_width, package_height) values {goods_list}
ON CONFLICT(id) do update
set name = excluded.name, package_width = excluded.package_width, package_height = excluded.package_height;"""
