...
- Все атаки происходят одновременно. Если в одном ходу произошла и победа над последним чудовищем и смерть героя - то игра проиграна.


В файле requirements_dev.txt содержится набор зависимостей для проверки качества кода
